...
class Ui_Dialog(object):
    ...
    def setDiscount(self):
        ...
        self.parent.productTable.modifyCell(currRow, 2, value, alignment = "right")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.Dialog.setWindowTitle(_translate("Dialog", "Price Update"))
        self.label.setText(_translate("Dialog", "New Price for "))
